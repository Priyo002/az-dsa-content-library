...
> _In competitive programming, time is everything. The STL Priority Queue is your ultimate shortcut for automatically keeping data sorted without having to constantly call `sort()`._
