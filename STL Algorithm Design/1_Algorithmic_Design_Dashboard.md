...
> *Algorithmic design is the systematic creation and optimization of data structures to solve specific computational problems. A well-designed algorithm encapsulates logic to handle massive streams of queries efficiently, ensuring simplicity and maintainability. Let's master the art of designing custom structs!*
...
5. `GetDistinct()`: Get the number of *distinct* values in $O(1)$ time.
